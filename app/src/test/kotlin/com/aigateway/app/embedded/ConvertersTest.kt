...
fun main() {
    ...
    // 13. Responses 请求 → canonical (instructions + input items)
    ...
    // 14. canonical → Responses body (system → instructions, messages → input items)
    ...
    // 15. Responses 响应 → canonical (output 数组)
